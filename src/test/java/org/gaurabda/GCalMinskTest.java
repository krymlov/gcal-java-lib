 ...
 * @version 1.0, 2024-11
 */
public class GCalMinskTest extends AGaurabdaTest {
    ...
    void testMonths(RepetitionInfo info) throws IOException {
        ...
        for (int month = 1; month <= 12; month++) {
            ...
            File file = new File("target/Minsk/" + year, "month_" + month + ".fst.xml");
